...
<!--                                <input id="bdate" name="bdate" type="text" class="form-control mask" data-inputmask="'alias': 'date'"  value="--><?php //echo $employee->bdate;?><!--" placeholder="Кк/Ой/Йил">-->
                    ...
                    <div class="form-group has-success lable-padd">
                        <label for="" class="col-md-3">Муассаса номи</label>
                        <div class="col-md-6">
                            <select name="kollej_id" id="kollej_id"
                                    class="form-control select22" <?php echo $username['is_admin'] == 0 ? 'readonly disabled' : ''; ?>>
                                <option value="">Танланг...</option>
                                <?php
                                $sel = $username['is_admin'] == 0 ? $username['kollej_id'] : $employee->kollej_id;
                                $this->PreferencesModel->getKollejDropList(0, 0, "&#166;&nbsp;&nbsp;&nbsp;&nbsp;", $sel);
                                ?>
                            </select>
...
<!--                            </select>-->
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group has-success lable-padd">
                        <label for="address" class="col-md-3">Манзил</label>
                        <div class="col-md-6">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"
                        onclick="document.location.href='<?php echo base_url('/employee/employees') ?>'"><i
                            class="fa fa-power-off"></i> Чиқиш
                </button>
