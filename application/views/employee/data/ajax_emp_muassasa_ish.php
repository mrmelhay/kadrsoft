                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-append date dpYears" id='datetimepicker2' data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input type="text" class="form-control" name="lavozim_bdate" id="lavozim_bdate" required value="<?php echo '';?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select name="shartnoma_type_id" id="shartnoma_type_id" class="form-control" required>
                            <option value="">Танланг...</option>
                            <?php $this->PreferencesModel->getShartnomatypeDropList(); ?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="block-web">
            <div class="porlets-content">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            <input type="text" name="ish_kir_buyruq" id="ish_kir_buyruq" class="form-control" maxlength="9" value="<?php echo '';?>" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-append date dpYears" id='datetimepicker2' data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input type="text" class="form-control" name="lavozim_tdate" id="lavozim_tdate" required value="<?php echo '';?>"/>
                            <span class="input-group-addon"> <i class="fa fa-calendar icon"></i></span> </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            <input type="text" name="ish_bush_sabab" id="ish_bush_sabab" class="form-control" maxlength="9" value="<?php echo '';?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            <input type="text" name="ish_bush_buyruq" id="ish_bush_buyruq" class="form-control" maxlength="9" value="<?php echo '';?>" required>
                        </div>
                    </div>
                </div>
