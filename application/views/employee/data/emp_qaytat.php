    ...
    <div class="invoice_header">
        <div class="row">
            <div class="col-sm-5">
                ...
                <h4>Қайта тайёрловдан ўтганлиги</h4> </span></div>
            </div>
            <div class="col-sm-7">
    ...
    <table class="table table-striped table-hover table-bordered" id="editable-sample">
        ...
        foreach ($qaytamalakas as $qaytamalaka) { ?>
            <tr class="">
                ...
                <td>
                    <?php echo $qaytamalaka['qayta_fan_name']; ?></td>
                <td>
                ...
                <td>
                    <div class="btn-group">
                        <a type="button" class="btn btn-default" href="#" data-kadrid="<?php echo $qaytamalaka['qaytat_id']; ?>" data-toggle="modal"  data-target="#myModal"> <i class="fa fa-edit green_info"></i> </a>
                        <a type="button" class="btn btn-default" href="#" data-kadrid="<?php echo $qaytamalaka['qaytat_id']; ?>" data-toggle="modal"  data-target="#myModalDelete">
