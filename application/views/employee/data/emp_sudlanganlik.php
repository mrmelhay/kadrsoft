    ...
    <div class="invoice_header">
        <div class="row">
            <div class="col-sm-5">
                ...
                <h4>Судланганлиги тўғрисида маълумотлар</h4> </span> </div>
            </div>
            <div class="col-sm-7">
        ...
        <table class="table table-striped table-hover table-bordered" id="editable-sample">
            ...
            <tr>
                <th>ТР</th>
                <th>Cудланган йили</th>
                <th>Cудланганлик ҳолати <br/><i>қайси кодекс ва қайси статья бўйича </i></th>
                <th>Амаллар</th>
            </tr>
            </thead>
            <tbody>
            ...
            foreach($sudlanganliks as $sudlanganlik){?>
                <tr class="">
                    ...
                    <td>
                        <?php echo $sudlanganlik['sud_kodeks']; ?></td>
                    <td>
                            <div class="btn-group">
