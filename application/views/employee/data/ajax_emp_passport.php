                ...
                <form action="" class="form-horizontal row-border">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 input-append date dpYears" id='datetimepicker2' data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input type="text" class="form-control" name="date_of_given" id="date_of_given" required>
                      ...
                      <button type="button" class="btn btn-danger"><i class="fa fa-calendar"></i></button>
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="date_of_expr" id="date_of_expr" required>
                            <span class="input-group-btn add-on">
                      <button type="button" class="btn btn-danger"><i class="fa fa-calendar"></i></button>
                      </span>
                        </div>
            ...
            <div class="porlets-content">
                <form action="" class="form-horizontal row-border">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group" >
                                <input type="text" class="form-control" name="davlat_id" id="davlat_id" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="viloyat_id" id="viloyat_id" required>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group icheck ">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                            <input type="checkbox" name="is_active" id="is_active" required>
                            </div>
                        </div>
                    </div>
                </form>
