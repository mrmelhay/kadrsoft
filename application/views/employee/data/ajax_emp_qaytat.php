<div class="row">
    <div class="col-md-6">
        <div class="block-web">
            <input type="hidden" name="qaytat_id" id="qaytat_id" value="<?php echo ''; ?>" />
            <div class="porlets-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-append date dpYears" id='datetimepicker2' data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input type="text" class="form-control" name="qayta_bdate" id="qayta_bdate" required value="<?php echo '';?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-append date dpYears" id='datetimepicker2' data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input type="text" class="form-control" name="qayta_tdate" id="qayta_tdate" required value="<?php echo '';?>"/>
                            <span class="input-group-addon"> <i class="fa fa-calendar icon"></i></span> </div>
                    </div>
                </div>
        ...
        <div class="block-web">
            <div class="porlets-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            <input type="text" name="qayta_xujjat_num" id="qayta_xujjat_num" class="form-control" maxlength="9" value="<?php echo '';?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-append date dpYears" id='datetimepicker2' data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input type="text" class="form-control" name="qayta_xujjat_date" id="qayta_xujjat_date" required value="<?php echo '';?>"/>
                            <span class="input-group-addon"> <i class="fa fa-calendar icon"></i></span> </div>
                    </div>
                </div>
                <div class="form-group ">
