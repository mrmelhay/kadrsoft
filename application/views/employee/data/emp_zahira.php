    ...
    <div class="invoice_header">
        <div class="row">
            <div class="col-sm-5">
                ...
                <h4>Раҳбарликка захирага олинганлиги</h4> </span> </div>
            </div>
            <div class="col-sm-7">
        ...
        <table class="table table-striped table-hover table-bordered" id="editable-sample">
            ...
            <tr>
                <th>ТР</th>
                <th>Қайси лавозимга захирага олинган</th>
                <th>Захирага олинган муддати</th>
                <th>Амаллар</th>
            </tr>
            </thead>
            <tbody>
            <?php foreach($muassasaishs as $muassasaish){?>
                <tr class="">
                    <td><? echo 1; ?></td>
                    <td><a href="#" data-title="" data-kadrid="<?php echo $muassasaish['lavozim_id']?>" data-toggle="modal"data-target="#myModal">
                            <?php echo $muassasaish['lavozim_id']; ?></a>
                    </td>
                    <td>
                        <?php echo $muassasaish['zahira_year']; ?></td>
