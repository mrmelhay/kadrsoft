        ...
        <div class="porlets-content">
            ...
            <div class="adv-table editable-table ">
                ...
                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                    ...
                    <?php
                    $counter = 0;
                    foreach ($lavozims as $lavozim) {
                        $counter++;
                        ?>
                        <tr class="">
                            <td><? echo $counter ?></td>
                            <td><a href="#" data-title="<?php echo $title;?>"
                                   data-lavozim_id=<?php echo $lavozim['lavozim_id']; ?> data-toggle="modal"
                                   data-target="#myModal"><?php echo $lavozim['lavozim_name'] ?></a></td>
                            <td class="center"><?php echo $lavozim['type'] ?></td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#" data-title="<?php echo $title;?>"
                                               data-kollej_id=<?php echo $lavozim['lavozim_id']; ?> data-toggle="modal"
                                               data-target="#myModal"><span class="fa fa-edit"> </span> Таҳрирлаш</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('preferences/del_lavozim/' . $lavozim['lavozim_id']) ?>"><span
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo base_url('/preferences/create_lovzim') ?>" class="form-horizontal" method="post">
...
<script>
    ...
    $('#myModal').on('shown.bs.modal', function (event) {
        ...
        var lavozim_id = button.data('lavozim_id');
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('preferences/ajax_data_lavozim')?>",
            data: {lavozim_id: lavozim_id},
            success: function (data) {
