    ...
    <div class="block-web">
        ...
        <div class="porlets-content">
            ...
            <div class="adv-table editable-table ">
                <div class="clearfix">
                    <div class="btn-group">
                        <button id="new_bank" type="button" class="btn btn-primary" data-title="<?php echo $title; ?>"
                    ...
                    foreach($banks as $bank){
                        ...
                        <tr class="">
                            ...
                            <td> <a href="#" data-title="<?php echo $title;?>"
                                    data-bank_id=<?php echo $bank['bank_id']; ?> data-toggle="modal"
                                    data-target="#myModal"><?php echo $bank['bank_filial_name'];?></td>
                            <td><?php echo $bank['bank_addres']?></td>
                            <td><?php echo $bank['bank_stir']?></td>
                            <td>
                                ...
                                <div class="btn-group btn-group-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li> <a href="<?php echo base_url('preferences/del_bank/' . $bank['bank_id']) ?>"><span class="fa fa-trash-o"> </span>  Ўчириш</a> </li>
                                    </ul>
                                </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo base_url('/preferences/create_bank') ?>" class="form-horizontal" method="post">
...
<script>
    ...
    $('#myModal').on('shown.bs.modal', function (event) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('preferences/ajax_data_bank')?>",
