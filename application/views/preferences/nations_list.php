...
<div class="container clear_both padding_fix">
    <div class="block-web">
        <div class="header">
            ...
            <h3 class="content-header">Мавжуд миллатлар рўйхати</h3>
        </div>
                            ...
                            <td>
                                <div class="btn-group btn-group-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li> <a href="<?php echo base_url('preferences/del_nation/' . $nation['millat_id']) ?>"<span class="fa fa-trash-o"> </span>  Ўчириш</a> </li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?php echo base_url('/preferences/create_nation') ?>" class="form-horizontal" method="post">
    ...
    <script>
        ...
        $('#myModal').on('shown.bs.modal', function (event) {
            ...
            var modal = $(this);
            var millat_id = button.data('millat_id');
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo base_url('preferences/ajax_data_nation')?>",
                data: {millat_id: millat_id},
