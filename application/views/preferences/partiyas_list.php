...
<div class="container clear_both padding_fix">
    <div class="block-web">
        <div class="header">
            ...
            <h3 class="content-header">Мавжуд партиялар рўйхати</h3>
        </div>
        <div class="porlets-content">
            ...
            <div class="adv-table editable-table ">
                <div class="clearfix">
                    <div class="btn-group">
                        <button id="new_partiya" type="button" class="btn btn-primary" data-title="<?php echo $title; ?>"
                ...
                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                    ...
                    <?php
                    $counter=0;
                    foreach($partiyas as $partiya){
                        $counter++;
                        ?>
                        <tr class="">
                            <td><? echo $counter?></td>
                            <td><a href="#" data-title="<?php echo $title;?>"
                                   data-partiya_id=<?php echo $partiya['partiya_id']; ?> data-toggle="modal"
                                   data-target="#myModal"><?php echo $partiya['partiya_name']?></td>
                            <td><a href="<?php echo $partiya['partiya_web']?>" target="_blank"><?php echo $partiya['partiya_web'];?></a></td>
                            ...
                            <td>
                                <div class="btn-group btn-group-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li> <a href="<?php echo base_url('preferences/del_partiya/' . $partiya['partiya_id']) ?>"><span class="fa fa-trash-o"> </span>  Ўчириш</a> </li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo base_url('/preferences/create_partiya') ?>" class="form-horizontal" method="post">
